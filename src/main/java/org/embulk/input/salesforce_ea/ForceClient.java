...
public class ForceClient {
  ...
  public ForceClient(PluginTask pluginTask)
      throws AsyncApiException, ConnectionException, URISyntaxException {
    this.pluginTask = pluginTask;
    this.partnerConnection = createConnectorConfig();
  }

  public InputStream query(Dataset dataset, int offset, String limit)
    ...
    String saql =
        createSaqlWithOffset(datasetId, dataset.getName(), Integer.toString(offset), limit);
  ...
  private String createRequest(ObjectMapper objectMapper, String saql)
  ...
  private URI getRequestURI(PartnerConnection connection, String path, String query)
  ...
  public InputStream post(URI uri, String sessionId, String request)
  ...
  private RequestConfig getRequestConfig() {
    int timeout =
        Integer.parseInt(
            System.getProperty(SYS_PROPERTY_SOCKET_TIMEOUT, pluginTask.getConnectionTimeout()));
  ...
  private InputStream execute(HttpUriRequest httpReq)
      throws UnsupportedOperationException, IOException {
